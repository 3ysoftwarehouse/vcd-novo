...
class VendaForm(forms.ModelForm):
    ...
    class Meta:
        fields = ('data_emissao', 'cliente', 'passageiro', 'ind_final', 'transportadora', 'mod_frete', 'veiculo', 'vendedor', 'desconto', 'local_orig',
                  'movimentar_estoque', 'pacote', 'tipo_desconto', 'frete', 'despesas', 'seguro', 'impostos', 'valor_total', 'cond_pagamento', 'observacoes',)

        widgets = {
            'data_emissao': forms.DateInput(attrs={'class': 'form-control datepicker'}),
            'cliente': forms.Select(attrs={'class': 'form-control'}),
            'passageiro': forms.Select(attrs={'class': 'form-control'}),
            'pacote': forms.Select(attrs={'class': 'form-control'}),
